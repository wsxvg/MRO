    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-xl border border-gray-100 p-5">
        ...
        <div class="flex gap-3">
          ...
          <button class="btn-secondary text-sm" :disabled="exporting === 'products'" @click="exportProducts">
            {{ exporting === 'products' ? '导出中...' : '导出商品' }}
          </button>
        </div>
      ...
      <div class="bg-white rounded-xl border border-gray-100 p-5">
        ...
        <div class="flex gap-3">
          ...
          <button class="btn-secondary text-sm" :disabled="exporting === 'customers'" @click="exportCustomers">
...
async function exportProducts() {
  ...
  } catch { exportError.value = '导出失败，请重试' }
